...
for x=-0.5*a:a/2000:0.5*a
    ...
    xx(cc)=x;
    cc1=0;
for Od=0*2*pi*1e6:5*2*pi*1e6/1000:5*2*pi*1e6 
           cc1=cc1+1;
           OODD(cc1)=Od/(2*pi*1e6);
...
figure
plot(OODD,Ip(1,:),'r-',OODD,Ip(2,:),'b-',OODD,Ip(3,:),'k-','LineWidth',2);
%红蓝黑代表123级
set(gca,'FontSize',14,'Fontname', 'Times New Roman');
xlabel('\Omega_d)','FontSize',30,'Fontname', 'Times New Roman');
